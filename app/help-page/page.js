      ...
      <Card className="rounded-none border-b">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mt-5">
            ...
            <ul className="list-disc ml-5">
              <li>
                <strong>Login Problems:</strong> Ensure you are using the correct username and password. If you’re locked out, use the password reset feature.
              </li>
              <li>
                <strong>Data Not Saving:</strong> If changes aren’t saving, check your internet connection and ensure all required fields are filled out.
              </li>
              <li>
                <strong>Slow Performance:</strong> Clear your browser cache or try a different browser to see if performance improves.
              </li>
            </ul>
